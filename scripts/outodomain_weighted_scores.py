...
def calc_score(type_corpus):
    ...
    for sp_c in type_corpus:
        ...
        print(sp_c +':'+ str(sum(score)/len(score))+'\n')

def generate_score(type_corpus):
    dir_path = "/Users/paggarwal/github_repos/model_cloning/data/postprocessed_noun/report_structured"
    tagger_f1 = []
    for sp_c in type_corpus:
        score = []
...
def main():
    ...
    # calc_score(spoken_cloned)
    # calc_score(spoken_orig)
    # calc_score(social_cloned)
    # calc_score(social_orig)
    # calc_score(formal_cloned)
    # calc_score(formal_orig)
    spoken_cloned_f1 = generate_score(spoken_cloned)
    print(spoken_cloned_f1)
    #generate_box_plot(spoken_cloned_f1)
